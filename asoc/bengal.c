...
static struct snd_soc_dai_link msm_mi2s_be_dai_links[] = {
	{
        ...
        .codec_name = "aw881xx_smartpa.0-0034",
        .codec_dai_name = "aw881xx-aif-0-34",
#else
		.codec_name = "msm-stub-codec.1",
		.codec_dai_name = "msm-stub-rx",
#endif
	...
	},
	{
		...
		.platform_name = "msm-pcm-routing",
#ifdef CONFIG_SND_HIFI_ES9218
        .codec_dai_name = "es9218-aif", 
		.codec_name = "hifi-es9218",	
#else
		.codec_name = "msm-stub-codec.1",
		.codec_dai_name = "msm-stub-rx",
#endif
