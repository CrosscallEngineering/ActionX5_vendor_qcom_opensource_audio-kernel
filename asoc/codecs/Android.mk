...
###########################################################
ifeq ($(BOARD_USES_AW88195_SMART_PA),true)
include $(CLEAR_VARS)
LOCAL_MODULE              := $(AUDIO_CHIPSET)_aw881xx.ko
LOCAL_MODULE_KBUILD_NAME  := aw881xx_dlkm.ko
LOCAL_MODULE_TAGS         := optional
LOCAL_MODULE_DEBUG_ENABLE := true
LOCAL_MODULE_PATH         := $(KERNEL_MODULES_OUT)
include $(DLKM_DIR)/AndroidKernelModule.mk
...
###########################################################
ifeq ($(BOARD_USES_AW87529_SOC_PA),true)
include $(CLEAR_VARS)
...
###########################################################
ifeq ($(BOARD_USES_ES9218_HIFI),true)
include $(CLEAR_VARS)
LOCAL_MODULE              := $(AUDIO_CHIPSET)_es9218.ko
LOCAL_MODULE_KBUILD_NAME  := es9218_driver_dlkm.ko
LOCAL_MODULE_TAGS         := optional
LOCAL_MODULE_DEBUG_ENABLE := true
LOCAL_MODULE_PATH         := $(KERNEL_MODULES_OUT)
include $(DLKM_DIR)/AndroidKernelModule.mk
